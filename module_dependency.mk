...
achiefn.o: cfpcoefc.o cfpgamma.o cqlcomm.o cqlconf.o diag.o  \
	diaggnde.o dskout.o efield.o exsweep.o finit.o impavnc0.o ntdstore.o  \
	ntloop.o param.o pltmain.o pltrun.o restvty.o sourcee.o tdoutput.o
...
ainplt.o: cqlcomm.o cqlconf.o param.o
...
cfpleg.o: bcast.o cqlcomm.o cqlconf.o param.o r8subs.o
...
coefmidt.o: bcast.o cqlcomm.o cqlconf.o param.o
coefmidv.o: bcast.o cqlcomm.o param.o r8subs.o
coefrfad.o: bcast.o cqlcomm.o cqlconf.o param.o
...
cqlcomm.o: cqlconf.o cqlconf.o param.o
cqlconf.o: param.o
...
diaggnde.o: bcast.o cqlcomm.o cqlconf.o diagcfac.o diagdenz.o  \
	diaggnde2.o diagwrng.o param.o r8subs.o soucrit.o
diaggnde2.o: bcast.o cfpleg.o cqlcomm.o cqlconf.o diagcfac.o  \
	diagdenz.o diagwrng.o param.o r8subs.o
...
impavnc0.o: advnce.o bcast.o bsl.o bsu.o coefmidt.o coefmidv.o  \
	coefstup.o coefwti.o coefwtj.o cqlcomm.o cqlconf.o esefld.o ilut.o  \
	impchk.o impnorm.o param.o r8subs.o tdtranspn.o tdtrvsou.o
...
pltdf.o: cqlcomm.o cqlconf.o lookup.o param.o r8subs.o
pltdnz.o: aminmx.o cqlcomm.o cqlconf.o param.o pltelec.o
pltelec.o: aminmx.o cqlcomm.o cqlconf.o param.o
...
pltmain.o: advnce.o aminmx.o bcast.o coefefad.o coefegad.o coeffpad.o  \
	...
	cqlcomm.o cqlconf.o diagentr.o fle.o param.o pltdf.o pltdnz.o  \
	pltendn.o pltfvsv.o pltlosc.o pltpower.o pltvec.o pltvflux.o  \
	r8subs.o
pltpower.o: aminmx.o cqlcomm.o cqlconf.o param.o
pltrun.o: aminmx.o cqlcomm.o cqlconf.o param.o r8subs.o tdnflxs.o
pltvec.o: advnce.o aminmx.o bcast.o coefefad.o coeffpad.o coefmidt.o  \
	coefmidv.o coefrfad.o coefstup.o cqlcomm.o cqlconf.o diagentr.o  \
	param.o pltvectr.o prppr.o r8subs.o
pltvectr.o: aminmx.o r8subs.o
pltvflux.o: aminmx.o cqlcomm.o cqlconf.o param.o r8subs.o
...
tdchief.o: achief1.o achiefn.o aclear.o aindfpa.o ainplt.o ainpltpa.o  \
	ainsetpa.o ampfar.o cfpgamma.o coefmidt.o coefmidv.o coefstup.o  \
	coefwti.o coefwtj.o cqlcomm.o cqlconf.o cqlconf.o diag.o diagentr.o  \
	diaggnde.o diagimpd.o diagscal.o dsk_gr.o dskout.o eflditer.o  \
	esefld.o netcdfrf.o ntdstore.o param.o pltendn.o pltinit.o pltmain.o  \
...
tdinterp.o: zcunix.o
tdnflxs.o: cqlcomm.o cqlconf.o diagwrng.o param.o
tdnpa.o: bcast.o cqlcomm.o param.o tdfinterp.o tdnpalam.o
tdnpa0.o: bcast.o cqlcomm.o cqlconf.o eqfpsi.o param.o tdnpa.o  \
...
tdsxr.o: bcast.o cfpleg.o cqlcomm.o cqlconf.o param.o r8subs.o  \
	tdnflxs.o tdwrng.o zcunix.o
tdsxr0.o: bcast.o cqlcomm.o cqlconf.o eqfpsi.o param.o tdsetsxr.o  \
	tdsxr.o tdsxrplt.o zcunix.o
tdsxray.o: cqlcomm.o param.o tdsxr0.o
tdsxrplt.o: aminmx.o cqlcomm.o cqlconf.o param.o r8subs.o
tdtloop.o: aindfpa.o cqlcomm.o cqlconf.o param.o tdeqdsk.o tdtscout.o  \
	tdwritef.o
...
tdtransp.o: cqlcomm.o param.o r8subs.o tdtravct.o tdtrchk.o  \
	tdtrrtov.o tdtrrtov2.o tdtrsym.o tdtrvtor.o tdtrvtor2.o tdtrwtl.o
tdtranspn.o: cqlcomm.o param.o r8subs.o tdtravct.o tdtrvtor.o  \
	tdtrwtl.o
tdtravct.o: bcast.o cqlcomm.o cqlconf.o param.o r8subs.o tdtrrtov.o  \
	tdtrrtov2.o tdtrsym.o tdtrvtor.o tdtrvtor2.o tdtrwtl.o
...
tdtrrsou.o: cqlcomm.o cqlconf.o param.o r8subs.o tdtravct.o tdtrrtov2.o  \
	tdtrvtor2.o
...
tdtry.o: cqlcomm.o cqlconf.o param.o tdwrng.o
tdtscinp.o: cqlcomm.o param.o tdeqdsk.o
tdtscout.o: cqlcomm.o param.o tdinterp.o
tdwritef.o: cqlcomm.o cqlconf.o param.o
tdwrng.o: param.o
tdxin13d.o: param.o profaxis.o
tdxin23d.o: param.o profaxis.o
tdxin33d.o: param.o profaxis.o
tdxinitl.o: bcast.o cqlcomm.o cqlconf.o micgetr.o param.o profaxis.o  \
	tdinterp.o tdpro.o tdtscinp.o tdwrng.o tdxin13d.o tdxin23d.o  \
	tdxin33d.o
...
urfbplt.o: bcast.o cqlcomm.o cqlconf.o param.o pltdf.o
urfchief.o: cqlcomm.o cqlconf.o param.o tdnflxs.o urfavg.o urfb0.o  \
	urfbes.o urfbplt.o urfdamp0.o urffflx.o urfpack.o urfrays.o  \
	urfread.o urfwrite.o
...
urfsetup.o: bcast.o cqlcomm.o netcdfrf.o param.o urfalloc.o  \
	urfread_.o
urfwrite.o: cqlcomm.o param.o urfwrite_.o
urfwrite_.o: cqlcomm.o param.o urfwr0.o urfwr0c.o
urfwrong.o: param.o
vlf.o: bcast.o cqlcomm.o cqlconf.o param.o r8subs.o urfedge.o  \
	urfwrong.o vlfbplt.o vlfsetup.o zcunix.o
vlfalloc.o: bcast.o cqlcomm.o param.o
vlfbplt.o: bcast.o cqlcomm.o cqlconf.o param.o pltdf.o r8subs.o  \
	urfwrong.o
vlfsetup.o: bcast.o cqlcomm.o param.o vlfalloc.o zcunix.o
vlh.o: bcast.o cqlcomm.o param.o vlhbplt.o vlhd.o
vlhbplt.o: bcast.o cqlcomm.o cqlconf.o param.o pltdf.o
vlhd.o: cqlcomm.o param.o
wpalloc.o: bcast.o cqlcomm.o cqlconf.o param.o
wparsou.o: bcast.o cqlcomm.o cqlconf.o param.o
...
wpelecf.o: advnce.o cqlcomm.o cqlconf.o param.o r8subs.o
wpinitl.o: bcast.o cqlcomm.o param.o r8subs.o wpwrng.o
wploweq.o: cqlcomm.o cqlconf.o param.o
